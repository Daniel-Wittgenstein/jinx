...
window.testSuite[0] = {
  ...
  tests: [
    {
      SKIP: true,
      name: "Wrong goto target",
      notes: `Should throw error because "start2" knot does not exist. (currently broken because -> fails to
        properly process as goto. Cause of bug unknown.)`,
      code: `
      -> start2
      === start
      `,
      compileError: true,
      compileErrorLineNr: 2,
    },
